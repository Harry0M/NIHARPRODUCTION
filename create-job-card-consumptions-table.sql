-- Manual creation of job_card_consumptions table
-- Run this in your Supabase SQL editor if migration fails

-- Drop table if exists (for clean recreation)
DROP TABLE IF EXISTS public.job_card_consumptions CASCADE;

-- Create the job_card_consumptions table
CREATE TABLE public.job_card_consumptions (
...
-- Success message
SELECT 'job_card_consumptions table created successfully!' as status;
