...
const mockJobs = {
  cutting: [
    { id: "JC-001", order: "ORD-2023-056", product: "Canvas Shopping Bag", quantity: 2000, progress: 75, worker: "Internal Team", jobCardId: "job-card-1" },
    { id: "JC-002", order: "ORD-2023-055", product: "Cotton Gift Bag", quantity: 1500, progress: 30, worker: "ABC Cutting Services", jobCardId: "job-card-2" },
    { id: "JC-003", order: "ORD-2023-054", product: "Jute Market Bag", quantity: 3000, progress: 15, worker: "Internal Team", jobCardId: "job-card-3" },
    { id: "JC-004", order: "ORD-2023-053", product: "Paper Carrier Bag", quantity: 5000, progress: 100, worker: "XYZ Fabricators", jobCardId: "job-card-4" },
  ],
  printing: [
    { id: "JP-001", order: "ORD-2023-056", product: "Canvas Shopping Bag", quantity: 2000, progress: 40, worker: "Prime Printing Co.", jobCardId: "job-card-1" },
    { id: "JP-002", order: "ORD-2023-053", product: "Paper Carrier Bag", quantity: 5000, progress: 90, worker: "Internal Team", jobCardId: "job-card-4" },
    { id: "JP-003", order: "ORD-2023-052", product: "Non-woven Promotional Bag", quantity: 2500, progress: 100, worker: "Prime Printing Co.", jobCardId: "job-card-5" },
  ],
  stitching: [
    { id: "JS-001", order: "ORD-2023-052", product: "Non-woven Promotional Bag", quantity: 2500, progress: 80, worker: "Stitch Perfect Inc.", jobCardId: "job-card-5" },
    { id: "JS-002", order: "ORD-2023-051", product: "Recycled Tote Bag", quantity: 1800, progress: 100, worker: "Internal Team", jobCardId: "job-card-6" },
  ],
  dispatch: [
    { id: "JD-001", order: "ORD-2023-051", product: "Recycled Tote Bag", quantity: 1800, progress: 100, worker: "Internal Team", jobCardId: "job-card-6" },
    { id: "JD-002", order: "ORD-2023-050", product: "Premium Gift Bag", quantity: 1200, progress: 100, worker: "Internal Team", jobCardId: "job-card-7" },
  ],
};
