...
export function useProductForm() {
  ...
  // Calculate consumption based on dimensions
  ...
  // Function to handle custom component changes
  ...
  // Function to add custom component
  ...
  // Function to remove custom component
