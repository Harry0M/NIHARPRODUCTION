...
const OrderNew = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Note: We don't include order_number as that's automatically generated by the database
      const orderData = {
      ...
      // Insert order into orders table - we don't need to provide order_number
      // as it's auto-generated by a database trigger
      const { data: orderData2, error: orderError } = await supabase
        .from("orders")
        // Use type casting to tell TypeScript that we're aware we're not including order_number
