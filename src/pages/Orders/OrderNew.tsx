...
const OrderNew = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Insert the order - we don't need to provide order_number as it's auto-generated by database trigger
      const { data: orderData, error: orderError } = await supabase
        ...
        .insert({
          ...
          // We don't need order_number here as it's auto-generated by a DB trigger
        })
        .select()
        .single();
