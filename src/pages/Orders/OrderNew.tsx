...
const OrderNew = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Prepare order data
      // Important fix: Handle company_name and company_id correctly for the check constraint
      const orderData = {
        // If company_id is provided, use it and set company_name to null
      ...
      // Insert order into orders table using type assertion to handle the order_number
      // that is automatically generated by the database
