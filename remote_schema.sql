...
CREATE OR REPLACE FUNCTION "public"."handle_purchase_completion_with_actual_meter"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
  item RECORD;
...
ALTER FUNCTION "public"."handle_purchase_completion_with_actual_meter"() OWNER TO "postgres";
...
COMMENT ON COLUMN "public"."purchase_items"."actual_meter" IS 'Actual meter quantity used for inventory calculations instead of main quantity';
...
CREATE OR REPLACE TRIGGER "purchases_actual_meter_trigger" AFTER UPDATE ON "public"."purchases" FOR EACH ROW EXECUTE FUNCTION "public"."handle_purchase_completion_with_actual_meter"();
...
GRANT ALL ON FUNCTION "public"."handle_purchase_completion_with_actual_meter"() TO "anon";
GRANT ALL ON FUNCTION "public"."handle_purchase_completion_with_actual_meter"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."handle_purchase_completion_with_actual_meter"() TO "service_role";
