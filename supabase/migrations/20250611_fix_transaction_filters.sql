-- Fix hard delete function to preserve both consumption AND purchase transactions
-- Only delete adjustment transactions and other non-essential transaction types

-- Drop and recreate the hard delete function with proper transaction filters
...
-- Recreated preview function with correct transaction filters
...
-- Recreated hard delete function with proper transaction filters
